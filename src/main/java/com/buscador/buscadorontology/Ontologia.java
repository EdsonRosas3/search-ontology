...
public class Ontologia {
	...
	private void CrearIndividuoQuesoDuro(){
	 ...
	 private void crearIndividuosQuesoSemiSuave() {
		 ...
		 ulloa.setPropertyValue(descripcion,modelo.createTypedLiteral(consultaDBpedia.GetDatoDbpedia("descripcion","Arzua_Ulloa_cheese")));
		 ulloa.setPropertyValue(pasteurizado,modelo.createTypedLiteral(consultaDBpedia.GetDatoDbpedia("pasteurizado","Arzua_Ulloa_cheese")));
		 ulloa.setPropertyValue(pais,modelo.createTypedLiteral(consultaDBpedia.GetDatoDbpedia("pais","Arzua_Ulloa_cheese")));
		 ulloa.setPropertyValue(nombre,modelo.createTypedLiteral(consultaDBpedia.GetDatoDbpedia("name","Arzua_Ulloa_cheese")));
		 ulloa.setPropertyValue(textura,modelo.createTypedLiteral(consultaDBpedia.GetDatoDbpedia("textura","Arzua_Ulloa_cheese")));
		 ulloa.setPropertyValue(procedencia,modelo.createTypedLiteral(consultaDBpedia.GetDatoDbpedia("source","Arzua_Ulloa_cheese")));
	 ...
	 private void crearIndividuosQuesoSuave(){
		 ...
		 Individual mozzarella = modelo.createIndividual(NS+":"+"Mozzarella", quesoSuave);
	...
	private void crearIndividuosPasta() {
		...
		spaghetti.setPropertyValue(ingrediente,modelo.createTypedLiteral(consultaDBpedia.GetDatoDbpedia("ingredient","Spaghetti")));
		...
		maultasche.setPropertyValue(ingrediente,modelo.createTypedLiteral(consultaDBpedia.GetDatoDbpedia("ingredient","Maultasche")));
		...
		ravioli.setPropertyValue(ingrediente,modelo.createTypedLiteral(consultaDBpedia.GetDatoDbpedia("ingredient","Ravioli")));
		...
		croxetti.setPropertyValue(ingrediente,modelo.createTypedLiteral(consultaDBpedia.GetDatoDbpedia("ingredient","Croxetti")));
		...
		pastina.setPropertyValue(ingrediente,modelo.createTypedLiteral(consultaDBpedia.GetDatoDbpedia("ingredient","Pastina")));
		...
		macaroni_casserole.setPropertyValue(ingrediente,modelo.createTypedLiteral(consultaDBpedia.GetDatoDbpedia("ingredient","Macaroni_casserole")));
